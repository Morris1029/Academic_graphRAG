...
- 若需要更好的文档解析兼容性，建议准备 Java 运行时（供 Apache Tika 使用）
...
如果希望只运行特定流程，可结合配置中的 `triggers` 使用 `--override`：
...
- `FULLGUIDE.md`：英文完整说明
- `README-CN.md`、`README-JA.md`：历史多语言说明
- `AGENTS.md`：面向开发代理的仓库协作说明

## 说明
- 当前 README 以“你的研究实现版本”为中心编写，不再完全沿用上游通用项目表述。
- 如果后续你准备把该仓库公开发表，建议再补充：
  - 研究数据来源说明
  - 模型选择依据
  - 复现实验表格
  - 典型问答案例
